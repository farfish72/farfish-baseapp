      ...
      <div className="glass-card-interactive rounded-4xl p-4 mb-4 group shadow-elevated backdrop-blur-4xl">
        ...
        <div className="flex items-center justify-between relative z-10">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-3xl bg-gradient-to-br from-white via-white to-white flex items-center justify-center shadow-glow group-hover:scale-110 transition-transform duration-300">
          ...
          <button
            ...
            className={`
              ...
              ${isPending || isConnected
                ...
                : "bg-gradient-to-r from-white to-white text-black hover:scale-105 shadow-glow hover:shadow-floating interactive-lift"
              }
            `}
          >
            {!isPending && !isConnected && (
        ...
        {error && (
          <div className="mt-4 p-4 rounded-4xl bg-white/15 border border-white/40 animate-slide-up backdrop-blur-xl shadow-soft">
            <div className="flex items-center gap-3">
              <span className="text-white text-lg">⚠️</span>
              <p className="text-sm font-semibold text-white flex-1">{error.message}</p>
            </div>
          </div>
        )}
      </div>
